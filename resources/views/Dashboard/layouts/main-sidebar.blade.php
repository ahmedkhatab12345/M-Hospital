		...
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
                    ...
                    <li class="slide">
                        <a class="side-menu__item" href=""><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24" >
                    ...
                    <li class="slide">
						...
						</svg><span class="side-menu__label">{{trans('Dashboard/main-sidebar_trans.sections')}}</span><i class="angle fe fe-chevron-down">
						</i></a>
                        <ul class="slide-menu">
					...
					<li class="slide">
						...
						<span class="side-menu__label">{{trans('Dashboard/main-sidebar_trans.doctors')}}</span><span style="font-size: 22px; margin-right:50px;" class="badge rounded-pill bg-danger">{{App\Models\Doctor::count()}}</span><i class="angle fe fe-chevron-down">
