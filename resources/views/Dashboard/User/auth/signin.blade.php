									...
									<div class="card-sigin">
										...
										<div class="card-sigin">
											...
											@if ($errors->any())
												...
												@endif
												<h2>{{trans('Dashboard/login_trans.welcome_backe')}}</h2>
												<div class="form-group">
												<label for="exampleFormControlSelect1">{{trans('Dashboard/login_trans.Select')}}</label>
												<select class="form-control" id="sectionChooser">
												<option value="" selected disabled>{{trans('Dashboard/login_trans.Choose')}}</option>
												<option value="admin">{{trans('Dashboard/login_trans.logadmin')}}</option>
												<option value="user">{{trans('Dashboard/login_trans.logpatient')}}</option>
                                            ...
                                            <div class="panel" id="user">
												<h5 class="font-weight-semibold mb-4">{{trans('Dashboard/login_trans.typep')}}</h5>
												<form  method="POST" action="{{ route('login.user') }}">
													...
													<div class="row row-xs">
														<div class="col-sm-6">
															<button class="btn btn-block"><i class="fab fa-facebook-f"></i> {{trans('Dashboard/login_trans.sign_in_fac')}}</button>
														</div>
														<div class="col-sm-6 mg-t-10 mg-sm-t-0">
															<button class="btn btn-info btn-block"><i class="fab fa-twitter"></i> {{trans('Dashboard/login_trans.sign_in_twi')}}</button>
														</div>
													</div>
												</form>
												<div class="main-signin-footer mt-5">
													<p><a href="">{{trans('Dashboard/login_trans.forget_pass')}}</a></p>
													<p>{{trans('Dashboard/login_trans.dont_have')}} <a href="{{ url('/' . $page='signup') }}">{{trans('Dashboard/login_trans.create')}}</a></p>
												</div>
												</div>

												<!--form admin-->
												<div class="panel" id="admin">
												<h5 class="font-weight-semibold mb-4">{{trans('Dashboard/login_trans.typea')}}</h5>
