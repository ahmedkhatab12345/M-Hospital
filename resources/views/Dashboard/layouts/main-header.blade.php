                ...
                <div class="dropdown nav-item main-header-notification">
                    ...
                    <div class="dropdown-menu dropdown-notifications">
                        <div class="menu-header-content bg-primary text-right">
                            ...
                            <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 notif-count"></p>
                        </div>
...
<script src="{{URL::asset('Dashboard/js/bundle/dropify.bundle.js')}}"></script>
...
<script>
    ...
    Echo.private('create-invoice').listen('.create-invoice', (data) => {
